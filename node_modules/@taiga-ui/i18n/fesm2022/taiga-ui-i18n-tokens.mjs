 ...
 */
const TUI_DEFAULT_LANGUAGE = new InjectionToken(ngDevMode ? 'TUI_DEFAULT_LANGUAGE' : '', {
 ...
 */
const TUI_LANGUAGE_STORAGE_KEY = new InjectionToken(ngDevMode ? 'TUI_LANGUAGE_STORAGE_KEY' : '', {
    factory: () => 'tuiLanguage',
});
