...
function migrateTuiMaskedMoneyValueIsEmpty(options) {
    ...
    references.forEach((ref) => {
        ...
        if (ng_morph_1.Node.isImportSpecifier(parent)) {
            ...
            parent.replaceWithText(`Number.isNaN(maskitoParseNumber(${value === null || value === void 0 ? void 0 : value.getText()}, {decimalSeparator: ','}))`);
        }
    });
}
function migrateTuiMaskedNumberStringToNumber(options) {
    ...
    references.forEach((ref) => {
        ...
        if (ng_morph_1.Node.isImportSpecifier(parent)) {
            ...
            parent.replaceWithText(`maskitoParseNumber(${value === null || value === void 0 ? void 0 : value.getText()}, {decimalSeparator: ${decimalSeparator === null || decimalSeparator === void 0 ? void 0 : decimalSeparator.getText()}})`);
        }
    });
}
//# sourceMappingURL=migrate-legacy-mask.js.map